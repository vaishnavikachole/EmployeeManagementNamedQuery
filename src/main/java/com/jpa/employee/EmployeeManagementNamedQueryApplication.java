...
public class EmployeeManagementNamedQueryApplication implements CommandLineRunner {

	@Autowired
	private EmployeeService employeeService;
	
	public static void main(String[] args) {
		SpringApplication.run(EmployeeManagementNamedQueryApplication.class, args);
	}
	...
	{
		Employee employee = new Employee("riya","ingole","riya2022@gmail.com",new Date());
